...
package com.nomura.risk.monju.proteus.client.impl;
 ...
 * Arguments:         -classpath "$Classpath$" com.nomura.risk.monju.proteus.client.impl.MDXClient --file $FilePath$ --user admin --password adminpwd
 ...
 * <p>
 * Add a --server arg to override the default (http://localhost:8082/proteus/xmla)
 */
public class MDXClient {
    ...
    private static final String DEFAULT_SERVER = "http://localhost:8082/proteus/xmla";
